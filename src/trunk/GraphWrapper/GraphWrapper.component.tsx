...
import { QueryRequestPolicy } from "../../hooks";

const GraphWrapperBase = (props: PropsWithChildren<unknown>): JSX.Element => {
  ...
  return <GraphqlProvider value={client.current}>{children}</GraphqlProvider>;
};
